...
Textures: floor/mesh textures you chose (including the built-in grass checker)
are original artwork generated by the editor and are baked into stNNN.tpl, so
they render in-game as shown in the editor.
